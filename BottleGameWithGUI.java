...
public class Game_GUI {
	...
	public static void main(String[] args) {
		...
		Text.add(Box.createVerticalStrut(50));// 添加排列间距 100
		Text.add(textArea2);

		ImageIcon image = new ImageIcon("./Bottles.png");//
		for (int i = 0; i < 21; i++) {
		...
		JTextField in = new JTextField(10);// 10 个字符的宽度
		Operation.add(in);
	...
	public static void Body(JPanel JP, JTextArea textArea4, JTextField in) {
		...
		playernum = Integer.parseInt(num);// 将字符串转换为 int
	...
	// 计算机使用算法--------核心思想：让电脑总是拿走剩余瓶子数与玩家的选择之和为 5
